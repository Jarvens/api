...
public class UserRegisterController {
    ...
    @ApiOperation(value = "查询", notes = "根据搜索关键字查询用户信息并分页")
    @ApiImplicitParams({
            @ApiImplicitParam(value = "分页", name = "eqlPage", required = true, dataType = "EqlPage"),
            @ApiImplicitParam(value = "搜索关键字", name = "key", dataType = "string")
    })
    public List<UserRegister> registerUserList(@RequestBody EqlPage eqlPage, String key) {
    ...
    @ApiOperation(value = "注册", notes = "平台用户注册")
    ...
    @ApiOperation(value = "删除", notes = "根据用户id删除用户信息")
