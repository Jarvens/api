 ...
 */
public abstract class SysLoginInterceptor extends LoginVerifyInterceptor {

    private static final Logger logger = LoggerFactory.getLogger(SysLoginInterceptor.class);
